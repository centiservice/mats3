...
public class Rule_MatsEndpoint<R, I> extends AbstractMatsTestEndpoint<R, Void, I> implements TestRule {
     ...
     * {@link #create(Rule_Mats, String, Class, Class) create(Mats_Rule, endpointId, replyClass, incomingClass)} to
     * easily supply the corresponding <code>{@literal @ClassRule}</code> {@link Rule_Mats} for fetching the
