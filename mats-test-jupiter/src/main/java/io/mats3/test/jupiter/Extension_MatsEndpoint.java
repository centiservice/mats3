...
public class Extension_MatsEndpoint<R, I> extends AbstractMatsTestEndpoint<R, Void, I>
    ...
    public Extension_MatsEndpoint<R, I> setProcessLambda(ProcessSingleLambda<R, I> processLambda) {
        log.debug("+++ Jupiter +++ setProcessLambda(" + processLambda + ") invoked.");
     ...
     * up on Jupiter lifecycle 'beforeEach' and tears it down on 'afterEach'. <b>Notice that a {@link MatsFactory} must
     ...
     * @return {@link Extension_MatsEndpoint} without a predefined processLambda.
     */
